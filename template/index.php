 ...
 * 音乐搜索器 - 模版文件
 *
 * @author  yjprolus <1793707713@qq.com>
 * @link    https://yjprolus.top/
 * @since   1.5.10
 *
 */
...
<head>
    ...
    <meta name="keywords" content="小杰音乐搜索,音乐搜索器,音乐试听,音乐在线听,网易云音乐,QQ音乐,酷狗音乐,酷我音乐,虾米音乐,百度音乐,一听音乐,咪咕音乐,荔枝FM,蜻蜓FM,喜马拉雅FM,全民K歌,5sing原创翻唱音乐">
    <meta name="description" content="小杰音乐搜索，可搜索试听网易云音乐、QQ音乐、酷狗音乐、酷我音乐、虾米音乐、百度音乐、一听音乐、咪咕音乐、荔枝FM、蜻蜓FM、喜马拉雅FM、全民K歌、5sing原创翻唱音乐。">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="apple-mobile-web-app-title" content="小杰音乐搜索">
    <meta name="application-name" content="小杰音乐搜索">
...
<body>
    <section class="am-g about">
        <div class="am-container am-margin-vertical-xl">
            <header class="am-padding-vertical">
                <h2 class="about-title about-color">小杰音乐搜索</h2>
            </header>
            <hr>
            <div class="am-u-lg-12 am-padding-vertical">
                <form id="j-validator" class="am-form am-margin-bottom-lg" method="post">
                    <div class="am-u-md-12 am-u-sm-centered">
                        ...
                        <div class="am-form-group">
                            <input id="j-input" data-filter="name" class="am-form-field am-input-lg am-text-center am-radius" placeholder="例如: 爱情转移 陈奕迅" data-am-loading="{loadingText: ' '}" pattern="^.+$" required>
                        ...
                        <button id="j-submit" type="submit" class="am-btn am-btn-primary am-btn-lg am-btn-block am-radius" data-am-loading="{spinner: 'cog', loadingText: '拼命寻找中，请稍候 ~~~', resetText: 'Get &#x221A;'}">找一下</button>
                    </div>
                </form>
                <form id="j-main" class="am-form am-u-md-12 am-u-sm-centered music-main">
                    ...
                    <div class="am-g am-margin-bottom-sm">
                        <div class="am-u-lg-6">
                            <div class="am-input-group am-input-group-sm am-margin-bottom-sm" data-am-popover="{content: '歌曲地址', trigger: 'hover'}">
                        ...
                        <div class="am-u-lg-6">
                            <div class="am-input-group am-input-group-sm am-margin-bottom-sm" data-am-popover="{content: '歌曲链接', trigger: 'hover'}">
                    ...
                    <div class="am-g">
                        ...
                        <div class="am-u-lg-6">
                            <div class="am-input-group am-input-group-sm am-margin-bottom-sm" data-am-popover="{content: '歌词', trigger: 'hover'}">
                    ...
                    <div class="am-g">
                        <div class="am-u-lg-6">
                            <div class="am-input-group am-input-group-sm am-margin-bottom-sm" data-am-popover="{content: '歌曲名称', trigger: 'hover'}">
                                <span class="am-input-group-label"><i class="am-icon-tag am-icon-fw"></i></span>
                                <input id="j-name" class="am-form-field" readonly>
                            </div>
                        </div>
                        <div class="am-u-lg-6">
                            <div class="am-input-group am-input-group-sm am-margin-bottom-sm" data-am-popover="{content: '歌曲作者', trigger: 'hover'}">
                ...
                <div class="am-u-md-12 am-u-sm-centered am-margin-vertical music-tips">
                    <h4>帮助：</h4>
                    <p><b>标红</b> 为 <strong>歌曲 ID</strong>，<u>下划线</u> 表示 <strong>歌曲地址</strong></p>
                    <ul>
                        <li>蜻蜓 FM 的歌曲 ID 需要使用 <code>| (管道符)</code> 组合，例如 <code>158696|5266259</code></li>
                        <li>全民 K 歌的歌曲名称请输入 <code>shareuid</code>，这是用户的 uid，搜索结果是该用户的所有公开作品</li>
                        <li>全民 K 歌的歌曲 ID 请输入 <code>shareid</code> 这是单曲分享 id，搜索结果是该单曲信息</li>
                    </ul>
    ...
    <footer class="footer">
        <p class="am-text-sm">v<?php echo MC_VERSION; ?>&nbsp;&copy;&nbsp;<?php echo date('Y'); ?>&nbsp;<a href="https://yjprolus.top" target="_blank" rel="author">回到首页</a>&nbsp;<a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">免责声明</a></p>
    </footer>
